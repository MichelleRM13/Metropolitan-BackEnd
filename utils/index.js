...
async function deploySC(contractName, args = []) {
  var smartContract = await hre.ethers.getContractFactory(contractName);
  var proxyContract = await hre.upgrades.deployProxy(smartContract, [...args], {
    kind: "uups",
  });
  
  if (process.env.HARDHAT_NETWORK) {
    console.log("Dentro de env hardhat network...")
